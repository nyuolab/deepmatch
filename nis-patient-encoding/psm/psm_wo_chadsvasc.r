...
# Data loading
fn = "/home/aisinai/work/repos/nis_patient_encoding/study_type/stroke_af/psm_result/FilteredDataForPSM.csv"
...
# 
all_features = c('AGE', 'FEMALE', 'CM_OBESE', 'HCUP_ED', 'HOSP_DIVISION',
